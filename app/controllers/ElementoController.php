...
class ElementoController extends BaseController {
  ...
  * @return object
  */
  public function api_actualizar_articulo_backend(){
  ...
  */
  ...
  public function api_obtener_datos_categoria_backend(){
    $sIdCategoria= Input::get('sIdCategoria');
    $Categoria = new Categoria();
    $oResultado = $Categoria->Obtener_datos($sIdCategoria);
    return Response::json(array('oResultado' => $oResultado));
  }

  /**
  * Setea las datos de una categoria
  * @return object
  */

  public function api_actualizar_categoria_backend(){
    $sTitulo = Input::get('sTitulo');
    $sDescripcion = Input::get('sDescripcion');
    $iHabilitado = Input::get('iHabilitado');
    $sIdCategoria = Input::get('sIdCategoria');
    ...
    $Categoria = new Categoria();
    $oResultado = $Categoria->Modificar_backend($sTitulo,$sDescripcion,$iHabilitado,$sIdCategoria);
    //dd($oResultado);die;
    return Response::json(array('oResultado' => $oResultado));
  }
}
